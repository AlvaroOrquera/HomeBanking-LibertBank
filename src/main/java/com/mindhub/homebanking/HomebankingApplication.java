...
//            Client admin = new Client("Alvaro", "Orquera", "alvarocapo2013@gmail.com", passwordEncoder.encode("Alvaro232315"));
...
//
//
//            Account vin001 = new Account("VIN001", LocalDate.now(), 5000, true, AccountType.CURRENT);
//            Account vin002 = new Account("VIN002", LocalDate.now().plusDays(1), 7500, true, AccountType.SAVING);
//            Account vin003 = new Account("VIN003", LocalDate.now(), 5000, true, AccountType.CURRENT);
//            Account vin004 = new Account("VIN004", LocalDate.now().plusDays(1), 7500, true, AccountType.SAVING);
...
//
//            Loans Hipotecario = new Loans("Mortgage", 500000, List.of(12, 24, 36, 48, 60), 35 );
//            Loans Personal = new Loans("Personal", 100000, List.of(6, 12, 24), 15);
//            Loans Automotriz = new Loans("Automotive", 300000, List.of(6, 12, 24, 36), 20);
//
...
//
//            Hipotecario.addClientsLoans(melbaHipotecario);
//            Personal.addClientsLoans(melbaPersonal);
//            Automotriz.addClientsLoans(alvaroAutomotriz);
//
...
//            Card cardMelbaGold = new Card("Melba Morel", CardType.DEBIT, CardColors.GOLD,
//                    "3325-5745-7876-4445",CardStatus.ACTIVE, "990", LocalDate.of(2021, 4, 26),LocalDate.of(2020, 4, 26));
//            Card cardMelbaTitanium = new Card("Mebal Morel", CardType.CREDIT, CardColors.TITANIUM,
//                    "2234-6745-5523-7888",CardStatus.ACTIVE, "750", LocalDate.of(2021, 4, 26), LocalDate.of(2026, 4, 26));
//            Card cardAlvaroSilver = new Card("Alvaro Orquera", CardType.CREDIT, CardColors.SILVER,
//                    "2234-6745-7876-4445",CardStatus.ACTIVE, "231", LocalDate.of(2021, 4, 26), LocalDate.of(2026, 4, 26));
//            numero1.addCard(cardMelbaGold);
//            numero1.addCard(cardMelbaTitanium);
//            numero2.addCard(cardAlvaroSilver);
//            cardService.cardSave(cardAlvaroSilver);
//            cardService.cardSave(cardMelbaTitanium);
//            cardService.cardSave(cardMelbaGold);
